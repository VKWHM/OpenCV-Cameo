...
class CaptureManager(object):
	...
	def __init__(self, capture, previewWindowManager = None, shouldMirrorPreview = False, shouldConvertBit10To8 = False, loggerName = 'CaptureManager'):
	...
	def enterFrame(self):
		...
		if self._capture is not None:
			if not self._capture.isOpened():
				...
				raise cv2.error("The device not opened. Make sure the device is working")
