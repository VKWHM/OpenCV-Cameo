...
class Cameo(object):
	...
	def onKeypress(self, keycode):
		...
		if keycode == 32: # space
			...
			self._logger.info("Face Tracking " + ('Started' if not self._shouldTrackingFace else 'Stoped'))
...
def get_args():
	...
	parser.add_argument('-d', '--use-depth', dest='depth', action='store_true', help='Use Depth Camera')
